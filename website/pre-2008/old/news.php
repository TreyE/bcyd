...
<? require('include/top_nav.php'); ?>
 ...
 style="vertical-align: top; background-image: url(img/middle_middle.jpg); background-repeat: repeat-y;">
	...
	<span style="font-size: 25px;
	  ...
	  color: #fff;">News:</span>
	<p>
	<a class="inside" href="http://www.bcyd.org/minutes/index.php">Meeting Minutes<a/>
	<br />
	<a class="inside" href="http://www.bcyd.org/newsletters.php">News Letters</a>
	</p>

	<p>
	<span style="color:#fff">
	<script language="JavaScript" src="http://www.baltimoresun.com/templates/misc/jsheadlines.jsp?slug=/news/local&limit=5"></script>
