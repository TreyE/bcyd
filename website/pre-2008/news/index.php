...
<? require('../include/top_nav.php'); ?>      
 ...
 style="vertical-align: top; background-image: url(img/middle_middle.jpg); background-repeat: repeat-y;">
	...
	<span style="font-size: 25px;
	  font-weight: bold;
	  color: #fff;">The County Ass:</span>
	<p>
	<a href="http://www.bcyd.org/news/october_04.pdf" class="inside">October, 2004</a>
	<br />
	<a href="http://www.bcyd.org/news/september_04.pdf" class="inside">September, 2004</a>
	</p>
